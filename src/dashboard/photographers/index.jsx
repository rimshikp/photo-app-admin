...
import styles from "./Graphers.module.css";
...
export default function PhotoGraphers() {
  ...
  const fetchCustomers = async (page = 1, search = "") => {
    ...
    setError(null);
    try {
      const response = await api.post("/users/list-photographers", {
        page: page,
        limit: itemsPerPage,
  ...
  const handleRowClick = (photographerId) => {
    navigate(`/dashboard/photographers/${photographerId}`);
  };
    ...
    <div className={styles.container}>
      <div className={styles.card}>
        <div className={styles.header}>
          <h1 className={styles.title}>Photographer</h1>
        ...
        {isLoading ? (
          ...
          <div className={styles.emptyState}>
            ...
            <h3 className={styles.emptyStateTitle}>No Photographer Found</h3>
            <p className={styles.emptyStateDescription}>
              {searchQuery
                ? "No photographer match your search criteria. Try a different search."
                : "You don't have any photographer yet. They will appear here once registered."}
            </p>
            {searchQuery && (
              <button
